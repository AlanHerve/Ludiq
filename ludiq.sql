...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 17 juin 2023 à 11:17
...
(23, 3, NULL, 'zdzdza', NULL, NULL, NULL, NULL, 0, 1, '2023-06-17 09:17:05');
...
--
ALTER TABLE `regular_post`
  MODIFY `ID_REGULAR_POST` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
